<h1 align="center">Hi, I'm Shaikh Md Aseel</h1>
<h3 align="center">AI Full-Stack Developer · App Developer
SGGS Institute of Engineering and Technology | Flutter & AI Enthusiast</h3>

<img src="https://readme-typing-svg.herokuapp.com?lines=AI+Full-Stack+Developer;Flutter+%26+Mobile+App+Developer;Building+with+Python+%2B+FastAPI;Solo+Builder+%7C+Ship+Real+Projects&font=Fira+Code&center=true&color=00F7FF&width=600&height=50"/>

## About Me
- B.Tech in Information Technology at SGGS Institute of Engineering and Technology, Nanded (2025–2028)
- Diploma in Computer Science (MSBTE) from GTMC, Nanded — 90.17% CGPA
- Flutter Development Intern at Dream Webbies Technologies
- Building cross-platform mobile apps, AI tools, and web-based utilities
- Strong practical understanding of AI-assisted coding workflows and prompt engineering
...
### Pixtract — OCR to PDF Scanner App
- Tech: Flutter, OCR, ML Kit, PDF Processing
- On-device text recognition for fast document extraction from handwritten or printed text
- Clean PDF generation workflow producing searchable digital documents

### Caesar Cipher Encryption Website
- Tech: HTML, CSS, JavaScript
- Web-based encryption platform for text encoding/decoding using Caesar Cipher logic
- File-based encryption handling with interactive user input processing

### Dither Me — Image Processing Website
- Tech: HTML, CSS, JavaScript
- Applies classic dithering algorithms (Floyd-Steinberg, ordered, Atkinson) to transform uploaded images
- Interactive browser-based real-time preview system

### ASCIIU — Live ASCII Cam
- Tech: JavaScript
- Real-time webcam-to-ASCII video converter using custom dithering and character-mapping

## GitHub Stats
<img src="https://github-readme-stats.vercel.app/api?username=Aseel012&show_icons=true&theme=tokyonight" width="48%"/>
<img src="https://github-readme-streak-stats.herokuapp.com/?user=Aseel012&theme=tokyonight" width="48%"/>
<img src="https://github-readme-stats.vercel.app/api/top-langs/?username=Aseel012&layout=compact&theme=tokyonight" width="48%"/>

## GitHub Trophies
<img src="https://github-profile-trophy.vercel.app/?username=Aseel012&theme=onestar&no-frame=true"/>

## Certifications
- Flutter Development Internship Certificate — Dream Webbies Technologies

## Achievements
- 90.17% CGPA in Diploma in Computer Science (MSBTE)
- Shipped multiple production web and mobile projects independently (Pixtract, Dither Me, ASCIIU, Caesar Cipher Tool)
- Completed a full-stack Flutter development internship building real production features

## Connect with Me
GitHub: [github.com/Aseel012](https://github.com/Aseel012)
LinkedIn: [linkedin.com/in/shaikh-md-aseel-29091b27b](https://www.linkedin.com/in/shaikh-md-aseel-29091b27b)
Email: shaikhmdaseel@gmail.com

◉ OPEN TO INTERNSHIPS &nbsp; ◉ OPEN TO COLLABS &nbsp; ◉ OPEN SOURCE WELCOME
